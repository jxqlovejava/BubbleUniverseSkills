...
> 来源：用户提供的选题方法图卡。采集/想选题时先问这三个问题，三个方向都要覆盖。

| 视角 | 核心问题 | 方法 | 案例 |
|------|---------|------|------|
| 用户的搜索 | 他们在搜什么？ | 平台搜索框输入赛道词，采集下拉联想词——全是真实搜索需求，直接当选题池 | 「穿搭」下拉词：穿搭夏季、穿搭女生高级感、穿搭推荐小个子、穿搭胖mm、穿搭思路和小技巧… |
| 用户的痛 | 他们有什么烦恼？ | 具体人群 + 具体烦恼，给解决方案型选题 | 「方圆脸微胖腿粗！17 套扬长避短夏日穿搭」 |
| 用户的好奇 | 他们想知道什么？ | 找高赞「如何 X」式选题，满足好奇心 | 「如何摆脱路人感‼️」（1.7 万赞） |

下拉联想词可直接用 Step 2 的 ego-browser 路径采（搜索框输入后不点搜索，抓 suggestion 列表）。
